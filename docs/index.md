...
See `docs/quickstart.md` to run your first pipeline and `docs/ui.md` for the complete keyboard reference. Use `docs/plan.md` for a focused walkthrough of `opal plan`, refer to `docs/pipeline.md` for deeper implementation details, check `docs/gitlab-parity.md` for the current GitLab feature coverage and parity gaps, and use `docs/rc-checklist.md` when preparing a release candidate.
