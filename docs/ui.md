...
4. **Log pane** – Streams job output live. Scroll with `↑/↓`, `PgUp/PgDn`, `Ctrl+u/d`, `g/G`, etc. Press `o` to open the full log in your pager.
...
- Logs live under `.opal/logs/<run-id>/<job>.log` if you need to inspect them outside the UI.
