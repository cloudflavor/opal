...
The MCP server currently exposes planning, run execution, run inspection, history listing, failed-job lookup, run-diff, plan-explanation, and engine-status tools for agent workflows.
