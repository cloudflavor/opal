...
The MCP server currently exposes planning, run execution, run inspection, history listing, failed-job lookup, and plan-explanation tools for agent workflows.
