...
impl From<&JobSpec> for Job {
    fn from(value: &JobSpec) -> Self {
        Self {
            ...
            inherit_default_image: value.inherit_default_image,
            ...
            inherit_default_cache: value.inherit_default_cache,
            inherit_default_services: value.inherit_default_services,
            inherit_default_timeout: value.inherit_default_timeout,
            inherit_default_retry: value.inherit_default_retry,
            inherit_default_interruptible: value.inherit_default_interruptible,
            when: value.when.clone(),
            rules: value.rules.clone(),
            only: value.only.clone(),
            except: value.except.clone(),
            artifacts: ArtifactConfig {
                name: value.artifacts.name.clone(),
                ...
                expire_in: value.artifacts.expire_in,
