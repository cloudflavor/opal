...
pub struct JobSpec {
    ...
    pub inherit_default_image: bool,
    pub inherit_default_before_script: bool,
    pub inherit_default_after_script: bool,
    pub inherit_default_cache: bool,
    pub inherit_default_services: bool,
    pub inherit_default_timeout: bool,
    pub inherit_default_retry: bool,
    pub inherit_default_interruptible: bool,
